    ...
    <div className="fade-in">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {/* Principles Grid with Clean Layout */}
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {/* Elites Global's Role Section - Clean Design */}
          <div className="text-center">
            <div className="relative bg-gradient-to-br from-gray-50 to-white rounded-2xl p-12 border border-gray-200 max-w-6xl mx-auto overflow-hidden">
              {/* Background Pattern */}
              <div className="absolute inset-0 opacity-5">
              ...
              >
                ...
                <div className="p-6 transform transition-transform duration-300 group-hover:translate-x-2">
                  ...
                  <div className="flex items-center text-sm text-green-600 mb-3">
                    <span className="bg-green-100 px-3 py-1 rounded-full text-xs font-medium transform group-hover:scale-105 transition-transform duration-300 shadow-sm">
                      🔗 Blockchain Verified
                    </span>
                  </div>
